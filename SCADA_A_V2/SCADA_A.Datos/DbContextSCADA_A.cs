...
public partial class DbContextSCADA_A: DbContext
{
        public DbContextSCADA_A()
    {
    }
    
    public DbContextSCADA_A(DbContextOptions<DbContextSCADA_A> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=<serverdb>;Database=<db>;User Id=<user>;Password=<password>;persist security info=True;Trust Server Certificate=True;");
